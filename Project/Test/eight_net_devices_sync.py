    ...
    while not stop_rendering:
        ...
        for i in range(curr_device_cnt):
            ...
            if depth_frame is not None:
                ...
                print(f"device{i} timestamp:{timestamp}")
            ...
            if color_image is not None and depth_image is not None:
                ...
                # print(f"device{i} timestamp:{timestamp} fps:{fps}")
...
def main():
    ...
    device_2 = ctx.create_net_device("192.168.1.11", 8090)
    ...
    device_7 = ctx.create_net_device("192.168.1.14", 8090)

    device_list = [device_0, device_1,device_2,device_3,device_4,device_5,device_6,device_7]
       ...
       # device = device_list.get_device_by_index(i)
        ...
        try:
            ...
            color_profile: VideoStreamProfile = (
                profile_list.get_stream_profile_by_index(1)
            )
        ...
        depth_profile = profile_list.get_stream_profile_by_index(1)
